...
(function () {
  ...
  // ===== 결과 화면 =====
  function showResult() {
    var scoreResult = reportGameResult({ gameId: 'add-balloon', playerCount: playerCount, scores: playerScores.slice(), metric: 'score' });
