...
// ── Result screen ─────────────────────────────────────────────
function showResult() {
  var scoreResult = reportGameResult({ gameId: 'add-dash', playerCount: playerCount, scores: scores.slice(), metric: 'score' });
  (function () {
