...
function generateQuestion() {
  ...
  if (b > a) [a, b] = [b, a]; // ensure a >= b (음수 없음)
  answer = a - b;
  expr   = `${fruit.repeat(a)} − ${fruit.repeat(b)} = ?`;
...
// ── Result screen ─────────────────────────────────────────────
function showResult() {
  var scoreResult = reportGameResult({ gameId: 'sub-fruit-count', playerCount: playerCount, scores: scores.slice(), metric: 'score' });
  (function () {
