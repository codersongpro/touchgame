...
const _GAME_CATEGORY_MAP = {
  'timing-tap': 'speed', 'double-tap': 'speed', 'dodge-rush': 'speed', 'stroop-tap': 'speed',
  'balance-team': 'coop', 'maze-guide': 'coop', 'signal-charades': 'coop',
  'flood-fill': 'puzzle', 'block-rotate': 'puzzle', 'mirror-maze': 'puzzle',
  ...
  'number-tap': 'math', 'clock-reading': 'math', 'math-sign': 'math', 'area-compare': 'math', 'dice-sum': 'math', 'number-bond': 'math', 'coin-count': 'math', 'skip-count': 'math', 'ten-frame': 'math',
  ...
  'animal-sort': 'knowledge', 'hangul-jamo': 'knowledge', 'opposite-word': 'knowledge', 'synonym-quiz': 'knowledge', 'unit-noun': 'knowledge', 'job-tool': 'knowledge', 'idiom-quiz': 'knowledge',
