...
const _GAME_CATEGORY_MAP = {
  'reaction-race': 'speed', 'balloon-pop': 'speed', 'bomb-dodge': 'speed', 'arrow-tap': 'speed', 'rps-react': 'speed', 'chase-tap': 'speed', 'odd-color': 'speed', 'flash-shape': 'speed',
  ...
  'number-tap': 'math', 'clock-reading': 'math', 'math-sign': 'math', 'area-compare': 'math',
  ...
  'secret-code': 'coop', 'color-signal': 'coop', 'sum-relay': 'coop', 'jamo-merge': 'coop', 'color-mix': 'coop', 'word-chain': 'coop', 'direction-relay': 'coop', 'clue-find': 'coop',
  'slide-puzzle': 'puzzle', 'maze-run': 'puzzle', 'pipe-connect': 'puzzle',
  'laser-reflect': 'puzzle', 'one-stroke': 'puzzle', 'dot-connect': 'puzzle',
  'paint-fill': 'puzzle', 'arrow-rotate': 'puzzle',
